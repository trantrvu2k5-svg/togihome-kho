...
| **Kho** (`togihome-kho`) | ceo · kho | Tồn kho · Cần đặt hàng · **Đơn mua** · Phiếu nhập · Phiếu xuất · Nhà cung cấp · Ghép mã | Ghi phiếu nhập/xuất (FIFO theo lô) · huỷ bằng phiếu ngược · duyệt quy đổi mã · **lập đơn mua NCC (WP-20): 5 bước moi→da_gui→xac_nhan→da_nhan→da_khop_hd + huỷ, cổng RPC** | phieu · phieu_dong · lo_nhap · ton · giao_dich · vat_tu · quy_doi · **don_mua · don_mua_dong · don_mua_lich_su (RPC dm_tao/dm_sua_dong/dm_chuyen_trang_thai/dm_danh_sach/dm_chi_tiet)** | nha_cung_cap · vat_tu · v_gia_tham_khao |
