#!/usr/bin/env python3
# L-79g-B2 buoc 4 — kiem ban GTM ASCII chay y het ban cu. src=KIEM-MAT-L79GB3.
...
GTM = (OPS / "gtm_ref_chat.min.js").read_text().replace("&src=gtm", "&src=KIEM-MAT-L79GB3")
...
rows = sql("select stt,kenh,ref_web,duong_dan,id_web from kho.click_chat where nguon_trang=$1 order by stt",["KIEM-MAT-L79GB3"])
